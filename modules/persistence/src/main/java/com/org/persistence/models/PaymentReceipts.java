...
public class PaymentReceipts {
        ...
        @Column(name="bank_authorization_id") private String bankAuthorizationId;
        @Column(name="bank_capture_id") private String bankCaptureId;
        @Column(name="bank_void_id") private String bankVoidId;
        @Column(name="bank_refund_id") private String bankRefundId;
